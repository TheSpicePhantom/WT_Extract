"""Demo: GPU-Instancing — viele farbige Quads + orthographische Kamera."""
...
def main() -> int:
    assert_gpu_only("instance_demo")

    window = Window(WindowConfig(title="WT Extract — Instanced Quads (GPU)", width=1280, height=720))
    window.focus()
    ...
    sprites = demo_sprite_field(cols=20, rows=12)
